...
解释：上图表示给出的链表。对于 n = 2 ，值为 1 的节点 1 是中间节点，用红色标注。值为 2 的节点 0 是移除节点 1 后剩下的唯一一个节点。
...
题解路径：. / leetcode_daily_stories / 26-06-15.md
...
if __name__ == '__main__':
    print(Solution().deleteMiddle(ListNode(1, ListNode(3, ListNode(4, ListNode(7))))).val)
