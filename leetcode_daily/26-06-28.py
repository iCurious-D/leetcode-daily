...
解释：我们可以重新排列 arr 得到 [1,2,2,2,1] ，该数组满足所有条件。arr 中最大元素为 2 。

示例 2：输入：arr = [100,1,1000]; 输出：3
解释：一个可行的方案如下：1. 重新排列 arr 得到 [1,100,1000] 。2. 将第二个元素减小为 2 。3. 将第三个元素减小为 3 。
...
if __name__ == '__main__':
    ...
    print(Solution().maximumElementAfterDecrementingAndRearranging(arr=[1, 2, 3, 4, 5]))
