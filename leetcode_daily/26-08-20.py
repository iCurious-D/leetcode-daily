...
示例 1：输入：nums = [2,1,3];     输出：[2,3,1]
解释：在前两次操作后，arr1 = [2] ，arr2 = [1] 。
在第 3 次操作中，由于 arr1 的最后一个元素大于 arr2 的最后一个元素（2 > 1），将 nums[3] 追加到 arr1 。
3 次操作后，arr1 = [2,3] ，arr2 = [1] 。因此，连接形成的数组 result 是 [2,3,1] 。

示例 2：输入：nums = [5,4,3,8];   输出：[5,3,4,8]
...
4 次操作后，arr1 = [5,3] ，arr2 = [4,8] 。因此，连接形成的数组 result 是 [5,3,4,8] 。
...
题解路径：. / leetcode_daily_stories / 26-08-20.md
...
if __name__ == '__main__':
    print(resultArray(nums=[2,1,3]))
    print(resultArray(nums=[5,4,3,8]))
