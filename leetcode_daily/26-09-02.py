...
示例 1：输入： nums1 = [2,3];     输出： true
解释：选择 nums2[0] = nums1[0] - nums1[1] = 2 - 3 = -1。选择 nums2[1] = nums1[1] = 3。
nums2 = [-1, 3]，两个元素均为奇数。因此答案为 true。
示例 2：输入： nums1 = [4,6];     输出： true
解释：选择 nums2[0] = nums1[0] = 4。选择 nums2[1] = nums1[1] = 6。
