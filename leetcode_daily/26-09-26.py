...
if __name__ == '__main__':
    ...
    code2 = """
        prompt = "Hello {name}".format(name="bob")
    """

    code3 = """
        d = {"name": "bob"}
        prompt = "Hello {name}".format_map(d)
    """

    print("=== f-string ===")
    dis.dis(textwrap.dedent(code1))

    print("\n=== format() ===")
    dis.dis(textwrap.dedent(code2))

    print("\n=== format_map() ===")
    dis.dis(textwrap.dedent(code3))
